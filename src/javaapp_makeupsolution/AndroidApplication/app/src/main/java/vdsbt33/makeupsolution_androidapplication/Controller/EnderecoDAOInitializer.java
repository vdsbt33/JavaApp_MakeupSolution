...
public class EnderecoDAOInitializer extends SQLiteOpenHelper {

    public static final String TABELA = "Endereco";
    public static final String CODIGO = "codEndereco";
    public static final String NOME = "nomeEndereco";
    public static final String NOME_BANCO = "MakeupSolution.db";
    public static final int VERSAO = 1;

    public EnderecoDAOInitializer(Context context) {
