...
public class CidadeEnderecoDAOInitializer extends SQLiteOpenHelper {

    public static final String TABELA = "CidadeEndereco";
    public static final String NOME_BANCO = "MakeupSolution.db";
    public static final int VERSAO = 1;

    public CidadeEnderecoDAOInitializer(Context context) {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS CidadeEndereco;");
        onCreate(db);
    }
}
