...
public class RuaEnderecoDAOInitializer extends SQLiteOpenHelper {

    public static final String TABELA = "RuaEndereco";
    public static final String NOME_BANCO = "MakeupSolution.db";
    public static final int VERSAO = 1;

    public RuaEnderecoDAOInitializer(Context context) {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS RuaEndereco;");
        onCreate(db);
    }
