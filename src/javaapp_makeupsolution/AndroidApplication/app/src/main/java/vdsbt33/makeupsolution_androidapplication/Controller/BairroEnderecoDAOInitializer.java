...
public class BairroEnderecoDAOInitializer extends SQLiteOpenHelper {

    public static final String TABELA = "BairroEndereco";
    public static final String NOME_BANCO = "MakeupSolution.db";
    public static final int VERSAO = 1;

    public BairroEnderecoDAOInitializer(Context context) {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS BairroEndereco;");
        onCreate(db);
    }
}
